...
当前公开 SDK 与萌卡 NT v1.9.1 的 198 个 action 同步，其中 QQ 宠物 30 个 API 均为普通公开接口，专属 Key 仅用于 `send_packet`。完整参数、返回值与 5 类事件说明见[萌卡 NT 开发文档](https://mknt.net/api/)；插件市场服务以官网审核通过的 API 与事件选择作为唯一权限来源。
