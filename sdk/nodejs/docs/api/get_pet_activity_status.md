...
- action：`get_pet_activity_status`
- 支持协议：Android。
...
```js
const result = await api.get_pet_activity_status({
  "self_id": 123456,
  "client_type": "android",
...
story_id、state_code、remaining_seconds、duration_seconds、started_at、recallable、finished。
