...
```js
const result = await api.bathe_friend_pet({
  "self_id": 123456,
  "client_type": "android",
  "pet_id": "Njc4OTAtcGV0",
  "item_id": "1",
...
submitted、effect_verified、pet_id、friend_uin；服务端提供时含 clean、mood、remaining、completed、extra_1、extra_2。
